            ...
            <table>
                ...
                <tr>
                    <td>Qual o principal meio de transporte utilizado para chegar ao IF Sudeste MG?
                        <br /><input type="radio" name="opt_qt03_Transporte" value="a pé / de bicicleta" onclick="if(document.getElementById('qt03_Tempo').disabled==true){document.getElementById('qt03_Tempo').disabled=false}; if(document.getElementById('qt03_ValorGastoDiario').disabled==false){document.getElementById('qt03_ValorGastoDiario').disabled=true}; if(document.getElementById('qt03_ValorGastoMensal').disabled==false){document.getElementById('qt03_ValorGastoMensal').disabled=true}; if(document.getElementById('qt03_Outro').disabled==false){document.getElementById('qt03_Outro').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'a pé / de bicicleta'}"> selected</c:if>>A pé / de bicicleta - Tempo gasto no trajeto&nbsp;<input type="text" id="qt03_Tempo" name="txt_qt03_Tempo" value="${formulario.qt03_Tempo}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        <br /><input type="radio" name="opt_qt03_Transporte" value="carona" onclick="if(document.getElementById('qt03_Tempo').disabled==false){document.getElementById('qt03_Tempo').disabled=true}; if(document.getElementById('qt03_ValorGastoDiario').disabled==false){document.getElementById('qt03_ValorGastoDiario').disabled=true}; if(document.getElementById('qt03_ValorGastoMensal').disabled==false){document.getElementById('qt03_ValorGastoMensal').disabled=true}; if(document.getElementById('qt03_Outro').disabled==false){document.getElementById('qt03_Outro').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'carona'}"> selected</c:if>>Carona
                        <br /><input type="radio" name="opt_qt03_Transporte" value="transporte coletivo com recursos próprios" onclick="if(document.getElementById('qt03_ValorGastoDiario').disabled==true){document.getElementById('qt03_ValorGastoDiario').disabled=false}; if(document.getElementById('qt03_Tempo').disabled==false){document.getElementById('qt03_Tempo').disabled=true}; if(document.getElementById('qt03_ValorGastoMensal').disabled==false){document.getElementById('qt03_ValorGastoMensal').disabled=true}; if(document.getElementById('qt03_Outro').disabled==false){document.getElementById('qt03_Outro').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'transporte coletivo com recursos próprios'}"> selected</c:if>>Transporte coletivo com recursos próprios - Gasto diário (R$):&nbsp;<input type="text" id="qt03_ValorGastoDiario" name="txt_qt03_ValorGastoDiario" value="${formulario.qt03_ValorGastodiario}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        <br /><input type="radio" name="opt_qt03_Transporte" value="transporte locado" onclick="if(document.getElementById('qt03_ValorGastoMensal').disabled==true){document.getElementById('qt03_ValorGastoMensal').disabled=false}; if(document.getElementById('qt03_ValorGastoDiario').disabled==false){document.getElementById('qt03_ValorGastoDiario').disabled=true}; if(document.getElementById('qt03_Tempo').disabled==false){document.getElementById('qt03_Tempo').disabled=true}; if(document.getElementById('qt03_Outro').disabled==false){document.getElementById('qt03_Outro').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'transporte locado'}"> selected</c:if>>Transporte locado - Gasto mensal (R$):&nbsp;<input type="text" id="qt03_ValorGastoMensal" name="txt_qt03_ValorGastoMensal" value="${formulario.qt03_ValorGastoMensal}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                        <br /><input type="radio" name="opt_qt03_Transporte" value="transporte gratuito de Prefeitura / Escola" onclick="if(document.getElementById('qt03_Tempo').disabled==false){document.getElementById('qt03_Tempo').disabled=true}; if(document.getElementById('qt03_ValorGastoDiario').disabled==false){document.getElementById('qt03_ValorGastoDiario').disabled=true}; if(document.getElementById('qt03_ValorGastoMensal').disabled==false){document.getElementById('qt03_ValorGastoMensal').disabled=true}; if(document.getElementById('qt03_Outro').disabled==false){document.getElementById('qt03_Outro').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'transporte gratuito de Prefeitura / Escola'}"> selected</c:if>>Transporte gratuito de Prefeitura / Escola
                        <br /><input type="radio" name="opt_qt03_Transporte" value="transporte próprio" onclick="if(document.getElementById('qt03_Tempo').disabled==false){document.getElementById('qt03_Tempo').disabled=true}; if(document.getElementById('qt03_ValorGastoDiario').disabled==false){document.getElementById('qt03_ValorGastoDiario').disabled=true}; if(document.getElementById('qt03_ValorGastoMensal').disabled==false){document.getElementById('qt03_ValorGastoMensal').disabled=true}; if(document.getElementById('qt03_Outro').disabled==false){document.getElementById('qt03_Outro').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'transporte próprio'}"> selected</c:if>>Transporte próprio
                        <br /><input type="radio" name="opt_qt03_Transporte" value="Outro" onclick="if(document.getElementById('qt03_Outro').disabled==true){document.getElementById('qt03_Outro').disabled=false}; if(document.getElementById('qt03_ValorGastoDiario').disabled==false){document.getElementById('qt03_ValorGastoDiario').disabled=true}; if(document.getElementById('qt03_ValorGastoMensal').disabled==false){document.getElementById('qt03_ValorGastoMensal').disabled=true}; if(document.getElementById('qt03_Tempo').disabled==false){document.getElementById('qt03_Tempo').disabled=true}" <c:if test="${formulario.qt03_Transporte == 'Outro'}"> selected</c:if>>Outro - Especifique&nbsp;<input type="text" id="qt03_Outro" name="txt_qt03_Outro" value="${formulario.qt03_Outro}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                    </td>
                </tr>
                <tr> 
                    <td><hr />QUESTÃO 04:</td>
                ...
                <tr>
                    <td>Qual a sua condição de manutenção?
                        <br /><input type="radio" name="opt_qt08_Manutencao" value="Sou responsável pelo meu próprio sustento" onclick="if(document.getElementById('qt08_Outra').disabled==false){document.getElementById('qt08_Outra').disabled=true}" <c:if test="${formulario.qt08_Manutencao == 'Sou responsável pelo meu próprio sustento'}"> selected</c:if>>Sou responsável pelo meu próprio sustento
                        <br /><input type="radio" name="opt_qt08_Manutencao" value="Sou sustentado pelos meus pais" onclick="if(document.getElementById('qt08_Outra').disabled==false){document.getElementById('qt08_Outra').disabled=true}" <c:if test="${formulario.qt08_Manutencao == 'Sou sustentado pelos meus pais'}"> selected</c:if>>Sou sustentado pelos meus pais
                        <br /><input type="radio" name="opt_qt08_Manutencao" value="Recebo ajuda de parentes" onclick="if(document.getElementById('qt08_Outra').disabled==false){document.getElementById('qt08_Outra').disabled=true}" <c:if test="${formulario.qt08_Manutencao == 'Recebo ajuda de parentes'}"> selected</c:if>>Recebo ajuda de parentes
                        <br /><input type="radio" name="opt_qt08_Manutencao" value="Tenho bolsa de estudo" onclick="if(document.getElementById('qt08_Outra').disabled==false){document.getElementById('qt08_Outra').disabled=true}" <c:if test="${formulario.qt08_Manutencao == 'Tenho bolsa de estudo'}"> selected</c:if>>Tenho bolsa de estudo
                        <br /><input type="radio" name="opt_qt08_Manutencao" value="Outra" onclick="if(document.getElementById('qt08_Outra').disabled==true){document.getElementById('qt08_Outra').disabled=false}" <c:if test="${formulario.qt08_Manutencao == 'Outra'}"> selected</c:if>>Outra - informe qual:&nbsp;<input type="text" id="qt08_Outra" name="txt_qt08_Outra" value="${formulario.qt08_Outra}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                    </td>
                </tr>
                <tr> 
                    <td><hr />QUESTÃO 09:</td>
                ...
                <tr>
                    <td>Você mora:
                        <br /><input type="radio" name="opt_qt09_Moradia" value="Sozinho" onclick="if(document.getElementById('qt09_Outra').disabled==false){document.getElementById('qt09_Outra').disabled=true}" <c:if test="${formulario.qt09_Moradia == 'Sozinho'}"> selected</c:if>>Sozinho
                        <br /><input type="radio" name="opt_qt09_Moradia" value="Com pais" onclick="if(document.getElementById('qt09_Outra').disabled==false){document.getElementById('qt09_Outra').disabled=true}" <c:if test="${formulario.qt09_Moradia == 'Com pais'}"> selected</c:if>>Com pais
                        <br /><input type="radio" name="opt_qt09_Moradia" value="Com cônjuge/companheiro(a)" onclick="if(document.getElementById('qt09_Outra').disabled==false){document.getElementById('qt09_Outra').disabled=true}" <c:if test="${formulario.qt09_Moradia == 'Com cônjuge/companheiro(a)'}"> selected</c:if>>Com cônjuge/companheiro(a)
                        <br /><input type="radio" name="opt_qt09_Moradia" value="Em casa de familiares ou amigos da família" onclick="if(document.getElementById('qt09_Outra').disabled==false){document.getElementById('qt09_Outra').disabled=true}" <c:if test="${formulario.qt09_Moradia == 'Em casa de familiares ou amigos da família'}"> selected</c:if>>Em casa de familiares ou amigos da família
                        <br /><input type="radio" name="opt_qt09_Moradia" value="Em repúnlica/quarto/pensão/pensionato" onclick="if(document.getElementById('qt09_Outra').disabled==false){document.getElementById('qt09_Outra').disabled=true}" <c:if test="${formulario.qt09_Moradia == 'Em repúnlica/quarto/pensão/pensionato'}"> selected</c:if>>Em repúnlica/quarto/pensão/pensionato
                        <br /><input type="radio" name="opt_qt09_Moradia" value="Outra situação" onclick="if(document.getElementById('qt09_Outra').disabled==true){document.getElementById('qt09_Outra').disabled=false}" <c:if test="${formulario.qt09_Moradia == 'Outra situação'}"> selected</c:if>>Outra situação - informe qual:&nbsp;<input type="text" id="qt09_Outra" name="txt_qt09_Outra" value="${formulario.qt09_Outra}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                    </td>
                </tr>
                <tr> 
                    <td><hr />QUESTÃO 10:</td>
                ...
                <tr>
                    <td>Quem é(são) o(s) responsável(is) pela manutenção financeira do grupo familiar?
                        <br /><input type="radio" name="opt_qt10_ResponsavelFinanceiro" value="Pai e mãe" onclick="if(document.getElementById('qt10_Outros').disabled==false){document.getElementById('qt10_Outros').disabled=true}" <c:if test="${formulario.qt10_ResponsavelFinanceiro == 'Pai e mãe'}"> selected</c:if>>Pai e mãe
                        <br /><input type="radio" name="opt_qt10_ResponsavelFinanceiro" value="Um dos pais" onclick="if(document.getElementById('qt10_Outros').disabled==false){document.getElementById('qt10_Outros').disabled=true}" <c:if test="${formulario.qt10_ResponsavelFinanceiro == 'Um dos pais'}"> selected</c:if>>Um dos pais
                        <br /><input type="radio" name="opt_qt10_ResponsavelFinanceiro" value="Outros membros do grupo familiar" onclick="if(document.getElementById('qt10_Outros').disabled==false){document.getElementById('qt10_Outros').disabled=true}" <c:if test="${formulario.qt10_ResponsavelFinanceiro == 'Outros membros do grupo familiar'}"> selected</c:if>>Outros membros do grupo familiar
                        <br /><input type="radio" name="opt_qt10_ResponsavelFinanceiro" value="Próprio estudante" onclick="if(document.getElementById('qt10_Outros').disabled==false){document.getElementById('qt10_Outros').disabled=true}" <c:if test="${formulario.qt10_ResponsavelFinanceiro == 'Próprio estudante'}"> selected</c:if>>Próprio estudante
                        <br /><input type="radio" name="opt_qt10_ResponsavelFinanceiro" value="Outros" onclick="if(document.getElementById('qt10_Outros').disabled==true){document.getElementById('qt10_Outros').disabled=false}" <c:if test="${formulario.qt10_ResponsavelFinanceiro == 'Outros'}"> selected</c:if>>Outros - informe quem:&nbsp;<input type="text" id="qt10_Outros" name="txt_qt10_Outros" value="${formulario.qt10_Outros}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                    </td>
                </tr>
                <tr> 
                    <td><hr />QUESTÃO 11:</td>
                ...
                <tr>
                    <td>Sua família reside em:
                        <br /><input type="radio" name="opt_qt12_Residencia" value="Vila ou aglomerado" onclick="if(document.getElementById('qt12_Outro').disabled==false){document.getElementById('qt12_Outro').disabled=true}" <c:if test="${formulario.qt12_Residencia == 'Vila ou aglomerado'}"> selected</c:if>>Vila ou aglomerado
                        <br /><input type="radio" name="opt_qt12_Residencia" value="Bairro padrão popular" onclick="if(document.getElementById('qt12_Outro').disabled==false){document.getElementById('qt12_Outro').disabled=true}" <c:if test="${formulario.qt12_Residencia == 'Bairro padrão popular'}"> selected</c:if>>Bairro padrão popular
                        <br /><input type="radio" name="opt_qt12_Residencia" value="Bairro padrão médio" onclick="if(document.getElementById('qt12_Outro').disabled==false){document.getElementById('qt12_Outro').disabled=true}" <c:if test="${formulario.qt12_Residencia == 'Bairro padrão médio'}"> selected</c:if>>Bairro padrão médio
                        <br /><input type="radio" name="opt_qt12_Residencia" value="Bairro padrão alto e luxo" onclick="if(document.getElementById('qt12_Outro').disabled==false){document.getElementById('qt12_Outro').disabled=true}" <c:if test="${formulario.qt12_Residencia == 'Bairro padrão alto e luxo'}"> selected</c:if>>Bairro padrão alto e luxo
                        <br /><input type="radio" name="opt_qt12_Residencia" value="Fora do perímetro urbano" onclick="if(document.getElementById('qt12_Outro').disabled==false){document.getElementById('qt12_Outro').disabled=true}" <c:if test="${formulario.qt12_Residencia == 'Fora do perímetro urbano'}"> selected</c:if>>Fora do perímetro urbano
                        <br /><input type="radio" name="opt_qt12_Residencia" value="Outro" onclick="if(document.getElementById('qt12_Outro').disabled==true){document.getElementById('qt12_Outro').disabled=false}" <c:if test="${formulario.qt12_Residencia == 'Outro'}"> selected</c:if>>Outro - especifique:&nbsp;<input type="text" id="qt12_Outro" name="txt_qt12_Outro" value="${formulario.qt12_Outro}" disabled="disabled" <c:if test="${operacao == 'Excluir'}"> readonly</c:if>>
                    </td>
                </tr>
                <tr> 
                    <td><hr />QUESTÃO 13:</td>
